...
| Team photos | **CONFIRMED 2026-09-18 for Jim Bennett, Jake Taylor, and Brandon Gurr; still UNVERIFIED for Kristine, Brooke, and Johnny** | About page team roster and team photo | Real photographs supplied by Jake Taylor on 2026-09-18, taken by him for the About page (himself at a ceiling leak; Jim and Brandon in a cabinet showroom). Supplying his own image, and photographing his co-founder and construction manager for this stated use, is the rights clearance; the exact page sentences are approved by Jake merging the PR that introduces them. Provenance, crop geometry, and the two frames that are NOT usable (a third party's face and another company's branding; a full ADL Solutions back print) are recorded in the private repo `855calljake-dev/gwf-media`. Outputs are EXIF-stripped; no GPS existed on any source. Captions and alt text describe what is visible and make no job, location, or date claim: whether the ceiling-leak frame was a Gold Water Fire job is unconfirmed, and line 48 below still stands. The other three team members render as initials until their photos are supplied the same way. |
...
| Team craftsmanship photos (pre-GWF work) | **CONFIRMED 2026-09-02, with a hard wording rule** | /craftsmanship.html gallery, homepage strip, three-image strips on every content page | Real photographs of residential reconstruction work performed by a current team member before Gold Water Fire existed (Gurr Brothers Construction era; source folder named in gwf-bos LEDGER). Jake confirmed rights and framing in writing 2026-09-02 and ruled that pages carry no Gurr Brothers or Brandon Gurr attribution. **The hard rule that makes that ruling safe:** every caption, alt text, heading, and JSON-LD entry credits "members of our team" and never presents any photo as a completed Gold Water Fire project — no locations, no dates, no per-photo job claims, alt text is factual description of what is visible. Canonical wording lives in `templates/craftsmanship.mjs` (`CREDIT_LINE`); reuse it, don't retype it. All published files were deduplicated, EXIF/GPS-stripped (originals carry homeowner GPS coordinates — never publish them raw), and individually screened for faces, readable documents, and identifying details. The exact page sentences were approved by Jake merging the PR that introduced them. |
